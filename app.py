...
def smart_bot_reply(message, history=None):
    """
    Bot smart — sauti ya binti wa Tanzania, anaungana na wahudumu,
...
def bot_chat():
    ...
    if client_lang in ("en", "sw", "fr") and not message.strip():
        pass  # detection still primary when user typed text
