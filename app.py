...
# Default mpya (Agosti 2026): username=njiaadmin  password=NjiaMauzo@2026
ADMIN_USER = os.environ.get("ADMIN_USER", "njiaadmin")
_ADMIN_PASS_ENV_SET = "ADMIN_PASS" in os.environ
ADMIN_PASS = os.environ.get("ADMIN_PASS", "NjiaMauzo@2026")
# Default credentials zimewekwa moja kwa moja — unaweza kubadilisha baadaye kwenye Admin Room.
