...
Admin: passwordless for 48h until 2026-08-22T18:05:00Z; then username+password required
"""
...
ADMIN_TEMP_OPEN_UNTIL = os.environ.get(
    "ADMIN_TEMP_OPEN_UNTIL", "2026-08-22T18:05:00Z"
).strip()
...
COUNTRY_PAYMENT_METHODS = {
    "Tanzania": ["M-Pesa", "Airtel Money", "Halotel", "Tigo Pesa", "PayPal", "Google Pay"],
    "Kenya": ["M-Pesa", "Airtel Money", "PayPal", "Google Pay"],
    "Uganda": ["MTN MoMo", "Airtel Money", "PayPal", "Google Pay"],
    "Rwanda": ["MTN MoMo", "Airtel Money", "PayPal", "Google Pay"],
    "Burundi": ["Lumicash", "Ecocash", "PayPal", "Google Pay"],
    "South Sudan": ["m-Gurush", "PayPal", "Google Pay"],
    "DR Congo": ["M-Pesa", "Airtel Money", "Orange Money", "PayPal", "Google Pay"],
    "Ethiopia": ["Telebirr", "PayPal", "Google Pay"],
    "Somalia": ["EVC Plus", "PayPal", "Google Pay"],
}
...
def api_payment_numbers():
    return jsonify({
        ...
        "numbers": {
            ...
            "tigo": "168603063",
            "tigo_pesa": "168603063",
            "paypal": "gsdtech20@gmail.com",
        },
        "labels": {
            "tigo": "Lipa Namba",
            "tigo_pesa": "Lipa Namba",
            "paypal": "PayPal email",
        },
    })
...
def api_payment_request():
    ...
    numbers = {
        ...
        "Tigo Pesa": "168603063", "PayPal": "gsdtech20@gmail.com",
        "MTN MoMo": "0766123456", "Lumicash": "0799123456",
...
if __name__ == "__main__":
    ...
    print("  Admin: passwordless for 48h until 2026-08-22T18:05:00Z; then username+password required")
    print("=" * 50)
