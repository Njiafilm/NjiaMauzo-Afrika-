...
ADMIN_USER = os.environ.get("ADMIN_USER", "njiajose")
_ADMIN_PASS_ENV_SET = "ADMIN_PASS" in os.environ
ADMIN_PASS = os.environ.get("ADMIN_PASS", "njiamauzo76")
# Default credentials zimewekwa moja kwa moja (si za muda) — hazihitaji kubadilishwa mara ya kwanza.
